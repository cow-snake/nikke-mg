...
Next step is to unlock the [**Shop**](../features/shops.md). Clearing stage 2-6 will do so, go to the main screen and claim the free goodie.
...
The [**Simulation Room**](../features/the-ark.md#simulation-room) is also open, do the tutorial, but don't enter 1-A yet, we will do that later today.

You also should have unlocked the [**BlaBla menu**](../features/main-screen.md#blabla-menu) and field missions already, you can skip them today, they are permanently available.
...
**3-3 unlocks the [Tribe Tower](../features/the-ark.md#towers),** come back to it when you clear 3-9.

When you clear 3-6 you will unlock the [**Tactics academy**](../features/outpost.md#tactics-academy)**. Ignore it for now,** but make sure to upgrade it **<span class="color-red">when you finish your day</span>**, each level unlocks really good stuff, for example: **increase afk rewards from outpost defense, free synchro device slots, and lots more\!**

To progress further you will need to collect all rewards available, your daily, weekly, day by day event… If there is an [**event ongoing**](../features/events.md), do it too. You will see a lot of red dots in the main screen, collect everything, level your Nikkes and push again.

**3-9 unlocks [Interception level D](../features/the-ark.md#interception-level-d-alteisen)**, you can also ignore it right now.

After that, [**Simulation Room**](../features/the-ark.md#simulation-room) should be already unlocked, clear **1-A and try 1-B**. This is where you get **skill manuals**, commonly called skill books, and battle data boxes.  
You can open these boxes in your [**inventory**](../features/inventory.md).
...
You unlock the [**Arena**](../features/the-ark.md#pvp-arenas) here, do your daily attacks with the same team you're using to push story, it does not matter if you win or not.
...
**When you defeat him, <span class="color-blue">Shifty</span> ![Shifty](../media/shifty.png){ width="50" } will bait you with [equipment upgrade](../features/nikkes.md#gears-and-collection-items). Skip the tutorial and equip the head piece you got, without upgrading it.**
...
4-15 Unlock the [**Synchro Device**](../features/outpost.md#synchro-device)**,** you can skip it until you unlock the **manufacturer towers on chapter 7, stage 7-13**.
...
Click on one of the **\+** signs, choose any blueprint you own, and start building. Each building has a 5 seconds build time, and once it's **finished, click on the building again** and it's done. You will need to collect and use all the blueprints to upgrade your [**Tactics Academy**](../features/outpost.md#tactics-academy) to its maximum level. If you cannot build more,
...
5-3 unlocks the [Lost Sector](../features/the-ark.md#lost-sector). Clear the first sector to receive a cube. Give the cube to your best burst 3 NIKKE.

5-10 unlock the [Recycling Room](../features/outpost.md#recycling-room), you can read the section later, keep pushing
...
5-20 unlocks [Liberation](../features/outpost.md#elevator-liberation), time gated free <span class="color-gold">SSR NIKKEs</span>\!
...
6-4 unlocks [**Solo Raid**](../raids/raids.md#solo-raid) and [**Collection items**](../features/nikkes.md#collection-and-favorite-items)**.** This is a limited monthly event, if you can't find the ![solo raid icon](../media/icon/soloraidicon.png){ width="30" } icon on your main screen, means that a solo raid isn't active.
...
**7-13 unlocks the Manufacturer Tower. This is the time when you want to visit the [synchro device](../features/outpost.md#synchro-device) section that was previously ignored.**
...
**9-15 Unlocks [interception level S](../features/the-ark.md#interception-level-s-gravedigger)**
...
**11-13 [SP ARENA](../features/the-ark.md#sp-arena)**
...
**And this is the end of the 14th day for me. If you used <span class="color-red">borrowed NIKKEs</span>, you probably are way past this chapter already. Have you unlocked [Interception EX](../features/the-ark.md#interception-ex-or-special-interception-si))? Check the guide for it\!**

**And from here, you will face [progression walls](../gameplay/progression-walls.md) and ho ho, there are a lot\!**
