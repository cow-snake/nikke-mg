...
Element Codes
As almost all gacha games, NIKKE also has an element system. The premise is pretty simple: if a stronger element NIKKE attacks, she will do more damage. Aside from a very specific case in Anomaly interception, there isn’t a damage penalty for being a weaker element, so don’t worry about it when building a team. 
...
We advise you to seek help from the discord servers for a better composition based on the NIKKEs you currently own. This is just the tip of the iceberg about team building.
Game Walkthrough
...
You unlock the Arena here, do your daily attacks with the same team you’re using to push story, it does not matter if you win or not. 
...
6-4 unlocks Solo Raid and Collection items. This is a limited monthly event, if you can’t find theicon on your main screen, means that a solo raid isn’t active. 
