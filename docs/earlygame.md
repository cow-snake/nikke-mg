...
As almost all gacha games, NIKKE also has an element system. **The premise is pretty simple: if a stronger element NIKKE attacks, she will do more damage. Aside from a very specific case in [Anomaly interception](#anomaly-interception-\(ai\)), there isn’t any sort of penalty for being a “weaker” element, so don’t worry about it when building a team.** 
...
**We advise you to seek help from the [discord servers](#useful-links) for a better composition based on the NIKKEs you currently own. This is just the tip of the iceberg about team building.**
...
Next step is to unlock the [**Shop**](#shopping-guides). Clearing stage 2-6 will do so, go to the main screen and claim the free goodie.
...
The [**Simulation Room**](#simulation-room) is also open, do the tutorial, but don’t enter 1-A yet, we will do that later today.

You also should have unlocked the [**BlaBla menu**](#blabla-menu) and field missions already, you can skip them today, they are permanently available.
...
**3-3 unlocks the [Tribe Tower](#towers),** come back to it when you clear 3-9.

When you clear 3-6 you will unlock the [**Tactics academy**](#tactics-academy)**. Ignore it for now,** but make sure to upgrade it **when you finish your day**, each level unlocks really good stuff, for example: **increase afk rewards from outpost defense, free synchro device slots, and lots more\!**

To progress further you will need to collect all rewards available, your daily, weekly, day by day event… If there is an [**event ongoing**](#events), do it too. You will see a lot of red dots in the main screen, collect everything, level your Nikkes and push again.

**3-9 unlocks [Interception level D](#interception-level-d-alteisen)**, you can also ignore it right now.

After that, [**Simulation Room**](#simulation-room) should be already unlocked, clear **1-A and try 1-B**. This is where you get **skill manuals**, commonly called skill books, and battle data boxes.   
You can open these boxes in your [**inventory**](#inventory,-hoarding-101). 
...
You unlock the [**Arena**](#pvp-arenas) here, do your daily attacks with the same team you’re using to push story, it does not matter if you win or not.   
...
**When you defeat him, Shifty ![Shifty](media/shifty.png ':size=50') will bait you with [equipment upgrade](#gears-and-collection-items). Skip the tutorial and equip the head piece you got, without upgrading it.**
...
4-15 Unlock the [**Synchro Device**](#synchro-device)**,** you can skip it until you unlock the **manufacturer towers on chapter 7, stage 7-13**.
...
Click on one of the **\+** signs, choose any blueprint you own, and start building. Each building has a 5 seconds build time, and once it’s **finished, click on the building again** and it’s done. You will need to collect and use all the blueprints to upgrade your [**Tactics Academy**](#tactics-academy) to its maximum level. If you cannot build more, 
...
5-3 unlocks the [Lost Sector](#lost-sector). Clear the first sector to receive a cube. Give the cube to your best burst 3 NIKKE.

5-10 unlock the [Recycling Room](#recycling-room), you can read the section later, keep pushing
...
5-20 unlocks [Liberation](#elevator-/-liberation), time gated free SSR NIKKEs\!
...
6-4 unlocks [**Solo Raid**](#solo-raid) and [**Collection items**](#collection-and-favorite-items)**.** This is a limited monthly event, if you can’t find the ![solo raid icon](media/icon/soloraidicon.png ':size=30') icon on your main screen, means that a solo raid isn’t active. 
...
**7-13 unlocks the Manufacturer Tower. This is the time when you want to visit the [synchro device](#synchro-device) section that was previously ignored.**
...
**9-15 Unlocks [interception level S](#interception-level-s-gravedigger)**
...
**And this is the end of the 14th day for me. If you used borrowed NIKKEs, you probably are way past this chapter already. Have you unlocked [Interception EX](#interception-ex-or-special-interception-\(si\))? Check the guide for it\!**

**And from here, you will face [progression walls](#progression-walls) and ho ho, there are a lot\!**